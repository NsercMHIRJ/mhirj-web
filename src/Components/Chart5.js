...
export default function Chart5() {
  ...
  function submit_chart5(e) {
    ...
    const path='http://mhirjapi.azurewebsites.net/api/chart_five/' +data_chart5.aircraft_no+ '/' +data_chart5.equation_id+ '/' +flightphase+ '/' +data_chart5.from_date+ '/' +data_chart5.to_date;
    axios.post(path)
      .then(res => {
